//! CtxFS SDK - Rust implementation
//!
//! This crate provides the core types, traits, and HTTP client for interacting with CtxFS server.
//!
//! # Modules
//!
//! - [`client`] - HTTP client for CtxFS server API
