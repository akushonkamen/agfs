//! CtxFS error types
//!
//! This module defines the unified error type used throughout CtxFS.

use thiserror::Error;

/// CtxFS unified error type
///
/// This enum represents all possible errors that can occur in CtxFS operations.
