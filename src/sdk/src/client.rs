//! CtxFS HTTP client
//!
//! This module provides the HTTP client for interacting with CtxFS server.
...
/// CtxFS client for connecting to CtxFS server
///
/// This client provides methods to interact with all CtxFS server API endpoints.
///
/// # Example
///
/// ```no_run
...
impl Client {
    ...
    /// Create a new CtxFS client with a custom HTTP client
