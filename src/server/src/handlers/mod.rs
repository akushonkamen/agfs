...
pub fn file_info_response(info: ctxfs_sdk::FileInfo) -> serde_json::Value {
    json!({
        "name": info.name,
        "size": info.size,
        "mode": info.mode,
...
pub fn list_response(infos: Vec<ctxfs_sdk::FileInfo>) -> serde_json::Value {
